...
DownloadTimer UtilitySwoDayOne::timer{"SWO"};
unordered_map<int, vector<double>> UtilitySwoDayOne::hashSwo;
const vector<QColor> UtilitySwoDayOne::swoPaints{
...
const vector<string> UtilitySwoDayOne::threatList{"HIGH", "MDT", "ENH", "SLGT", "MRGL"};

void UtilitySwoDayOne::get() {

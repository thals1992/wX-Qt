...
vector<double> WXGLNexradLevel3Common::drawLine(
...
vector<double> WXGLNexradLevel3Common::computeMercatorNumbersFromEc(const ExternalGlobalCoordinates& ec, const ProjectionNumbers& projectionNumbers) {
